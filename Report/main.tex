...
\hl{The filter was tuned by adjusting the filter's knowledge of process noise in the system until the simulations reliably generated NEES and NIS results in}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/{NEESNIS_lkf_N10Q1.0E-09}.png}
	\caption{NEES and NIS chi-square results over time for N= \hl{N} simulated trajectories. Data points continue to grow past 200 seconds into the analysis.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{./Figures/{NEESNIS_ekf_N10Q1.0E-09}.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/ukf_estimate_th.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{./Figures/{NEESNIS_ukf_N10Q1.0E-09}.png}
	\caption{NEES and NIS chi-square results over time for N= \hl{N} simulated trajectories.}
